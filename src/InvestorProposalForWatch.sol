...
contract InvestorProposalForWatch is ERC20{ 
    ...
    error InvestorProposalForWatch__AuctionNotEndedOrRemainingAmountNotFulfilled();
    ...
    function investorWithdrawLoanAmount(
        uint256 _proposalNum
    ...
    revert InvestorProposalForWatch__AuctionNotEndedOrRemainingAmountNotFulfilled();
}
